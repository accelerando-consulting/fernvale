...
Leaf *leaves[] = {
	...
	new BatteryLevelLeaf("battlvl",   LEAF_PIN(0),100000,200000,12,1),

	(new ButtonLeaf("btn1", LEAF_PIN(37), LOW, false))->setMute(),
	(new ButtonLeaf("btn2", LEAF_PIN(38), LOW, false))->setMute(),
	(new ButtonLeaf("btn3", LEAF_PIN(39), LOW, false))->setMute(),
	new LVGLLeaf("screen", 3),
	new FernvaleAppLeaf("app", "fs,screen,btn1,btn2,btn3"),
